  ...
  const testimonials = [
    {
      ...
      role: "Research Scholar, Data Science Lab, IIT Guwahati",
      image: "/digata.jpg", // Public image
    ...
    },
    {
      ...
      image: "", // No image available, will fall back to initial
    ...
    
    {
      ...
      image: "/placeholder.svg", // Use placeholder instead of missing file
